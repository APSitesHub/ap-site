...
const KidsDeA2 = () => {
  ...
  useEffect(() => {
    document.title = 'A2 Deutsch Kids | AP Education';
    ...
    socketRef.current.on('question:input', data => {
      if (data.page === room.replace('/streams-kids/', '') + 'kids') {
  ...
  return (
    <>
      ...
      {(links.dea2kids === undefined || links.dea2kids[0] < 10) && !isLoading ? (
        <StreamPlaceHolder>
          <StreamPlaceHolderText>
            Привіт! <br />
