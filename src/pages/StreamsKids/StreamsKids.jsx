...
import { AdminFormBtn, LoginForm } from '../Streams/AdminPanel/AdminPanel.styled';
          ...
          >
            <LoginForm>
              ...
              <StreamAuthText>
                ...
                маєте доступ до нашої платформи, то й до цієї сторінки теж. Введіть дані,
                які ви використовуєте для входу на платформу.
              </StreamAuthText>
              <Label>
                <LoginInput
                  type="text"
