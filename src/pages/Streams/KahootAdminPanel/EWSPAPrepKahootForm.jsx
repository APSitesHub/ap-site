          ...
          <LinksForm>
            <Label>
              <AdminInput
                ...
                name="ewspa_prep_1"
                autoComplete="off"
                placeholder="Перший кахут для EWSPA Prep"
              />
            </Label>
            <Label>
              <AdminInput
                ...
                name="ewspa_prep_2"
                autoComplete="off"
                placeholder="Другий кахут для EWSPA Prep"
              />
            </Label>
            <Label>
              <AdminInput
                ...
                name="ewspa_prep_3"
                autoComplete="off"
                placeholder="Третій кахут для EWSPA Prep"
              />
            </Label>
            <Label>
              <AdminInput
                ...
                name="ewspa_prep_4"
                autoComplete="off"
                placeholder="Четвертий кахут для EWSPA Prep"
              />
            </Label>
            <Label>
              <AdminInput
                ...
                name="ewspa_prep_5"
                autoComplete="off"
                placeholder="П'ятий кахут для EWSPA Prep"
              />
            </Label>
            <LabelCheckBox>
