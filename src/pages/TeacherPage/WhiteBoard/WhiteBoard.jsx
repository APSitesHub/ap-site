...
export const WhiteBoard = ({ page, isWhiteBoardOpen, isOpenedLast, sectionWidth }) => {
  ...
  const BOARDS = {
    ...
    // a2: 'https://onlineboard.eu/b/VhaRqjEp',
    // b1: 'https://limnu.com/d/draw.html?b=B_3XD5qpFWQjqvyi&',
    // b1: 'https://onlineboard.eu/b/12TCWCKs',
    ...
    wskm_cnc: 'https://limnu.com/d/draw.html?b=B_HRtlAHolQT2xVA&',
    ...
    shvets: 'https://limnu.com/d/draw.html?b=B_qPq6cu5dT0ygVr&',
    tsvihun: 'https://limnu.com/d/draw.html?b=B_hGfXGmNCQYibK1&',
  };
