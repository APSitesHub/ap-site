...
const TeacherPageIndividualPartners = () => {
  ...
  const togglePDF = () => {
    !isOpenedLast
      ...
      : isOpenedLast === 'pdf' && setIsPDFOpen(isPDFOpen => !isPDFOpen);
    isWhiteBoardOpen ||
    isViewerOpen ||
    isPlatformOpen ||
    isKahootOpen ||
  ...
  const toggleQuizInput = () => {
    !isOpenedLast
      ...
      : isOpenedLast === 'input' &&
        setIsQuizInputOpen(isQuizInputOpen => !isQuizInputOpen);
    isPlatformOpen || isWhiteBoardOpen || isViewerOpen || isPDFOpen || isKahootOpen
  ...
  return (
    <>
      ...
      <Partners sectionWidth={width} isPDFOpen={isPDFOpen} isOpenedLast={isOpenedLast} />
...
export default TeacherPageIndividualPartners;
