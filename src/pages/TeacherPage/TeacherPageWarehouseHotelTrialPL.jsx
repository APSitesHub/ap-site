...
import { PlatformTrialLessonPl } from './Platform/PlatformTrialLessonPl';

const TeacherPageWarehouseHotelTrialPL = () => {
...
export default TeacherPageWarehouseHotelTrialPL;
