...
const StreamDeutschA02Sprechclub = () => {
            ...
            <StreamsBackgroundWrapper>
              ...
              !links.trials_de.includes('youtu.be')
                ? window.location.replace(
                    'https://us06web.zoom.us/j/83592737389?pwd=ppFa21TVcMhrHDiJACdabFAEMrC1Ne.1#success'
                  )
                : null}
              {height > width && (
                <ChatBox
...
export default StreamDeutschA02Sprechclub;
