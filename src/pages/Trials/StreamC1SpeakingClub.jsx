...
const StreamC1SpeakingClub = () => {
  ...
  useEffect(() => {
    document.title = 'C1 Speaking Club | AP Education';
            ...
            <StreamsBackgroundWrapper>
              ...
              !links.trials_de.includes('youtu.be')
                ? window.location.replace(
                    'https://us06web.zoom.us/j/86102616007?pwd=2K6BVQpo4uf4NZGa01mCV5yuROTDCz.1#success' 
                  )
                : null}
              {height > width && (
                <ChatBox
...
export default StreamC1SpeakingClub;
