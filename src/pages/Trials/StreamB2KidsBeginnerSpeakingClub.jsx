...
const StreamTrialB2KidsBeginnerSpeakingClub = () => {
  ...
  useEffect(() => {
    document.title = 'B2 Kids Beginner Speaking Club | AP Education';
...
export default StreamTrialB2KidsBeginnerSpeakingClub;
