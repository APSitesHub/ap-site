...
import logo from '../../img/svg/myap/uni-logos/vpu.png';
...
const pltimetable = [
  ...
  {
    day: 5,
    subject: 'Poland and its culture - introduction for foreigners',
    lessonNumber: '2',
    time: '13:00',
    marathon: 'cnc',
  },
  ...
  return (
    <StreamSection>
      {!isUserLogged ? (
        ...
        >
          <LoginForm>
            <UniLoginLogo src={logo} alt="VPU logo" />
            <LoginFormTextWSPA>
              Dzień dobry!
              <br />
